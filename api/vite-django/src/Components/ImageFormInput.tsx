                            ...
                            {!previewUrl ? (
                                ...
                                >
                                    <div className="flex flex-col items-center justify-center text-center">
                                        <span className="text-2xl mb-1.5">📸(ще поки не пояснив цей компонент)</span>
                                ...
                                <div
                                    className="relative flex flex-col items-center bg-slate-50 dark:bg-slate-950 p-2.5 rounded-xl border border-slate-200 dark:border-slate-800">
                                    <img
                                        src={previewUrl}
